 ...
 * Hash map's keys are chatrooms' names
 * 
 ...
 * 
 * @returns {String} Returns the result of the redis client's hset method
 */
...
const isUserAdmin = (chatroom, user) => {
    ...
    // only the user who created a chatroom has admin privileges
    // admin can delete a chatroom
